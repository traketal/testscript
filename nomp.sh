...
# SED config file
sudo cp -r $HOME/veilpool/install/config.json $STORAGE_ROOT/nomp/site/config.json
...
sudo cp -r $HOME/veilpool/install/base_samp.json.x $STORAGE_ROOT/nomp/site/pool_configs/veil.json
